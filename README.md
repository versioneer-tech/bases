...
lakefs-oss-contrib/
  default/
    kustomization.yaml # needs ${LAKEFS_BLOCKSTORE_ACCESS_KEY_ID} ${LAKEFS_BLOCKSTORE_SECRET_ACCESS_KEY} ${LAKEFS_BLOCKSTORE_REGION} ${LAKEFS_BLOCKSTORE_ENDPOINT} ${LAKEFS_S3_DOMAIN_NAME} ${LAKEFS_INSTALLATION_USER_NAME} ${LAKEFS_INSTALLATION_ACCESS_KEY_ID} ${LAKEFS_INSTALLATION_SECRET_ACCESS_KEY}
```
